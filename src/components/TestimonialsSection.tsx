  ...
  return (
    <div ref={containerRef} className="h-[80vh] flex items-center justify-center sticky top-24 sm:top-32 px-6 sm:px-12 z-20">
      <motion.div
        ...
        className="relative w-full max-w-[850px] h-[360px] sm:h-[460px] rounded-[2.5rem] p-8 sm:p-12 flex flex-col justify-between border border-white/10 backdrop-blur-[32px] overflow-hidden shadow-[0_0_50px_rgba(0,0,0,0.5),inset_0_0_20px_rgba(255,255,255,0.05)]"
      >
